          ...
          <div className={styles.quizCard}>
            {submitted ? (
              ...
              <>
                ...
                <button
                  className={`${styles.quizNext} ${answers[step] !== undefined ? styles.quizNextActive : ''} ${shakeNext ? 'shake' : ''}`}
                  onClick={nextStep}
                >
                  Далее →
                </button>
              ...
              <>
                ...
                <div className={styles.quizForm}>
                  <input className={styles.quizInput} placeholder="Ваше имя *" required value={contactForm.name} onChange={(e) => setContactForm({ ...contactForm, name: e.target.value })} />
                  <input className={styles.quizInput} placeholder="Номер телефона *" required type="tel" value={contactForm.phone} onChange={(e) => setContactForm({ ...contactForm, phone: e.target.value })} />
                  <input className={styles.quizInput} placeholder="Telegram @ник (необязательно)" value={contactForm.telegram} onChange={(e) => setContactForm({ ...contactForm, telegram: e.target.value })} />
                  <button
                ...
                <button className={styles.quizBack} onClick={prevStep}>← Назад</button>
